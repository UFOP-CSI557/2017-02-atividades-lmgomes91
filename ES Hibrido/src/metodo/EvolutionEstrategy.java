...
public class EvolutionEstrategy {
    ...
    public void executar() {
        ...
        PopulacaoDouble populacao = new PopulacaoDouble(min, max, nvar, mu);
        populacao.criar();
    ...
    private void crossoverDoisPontos(IndividuoDouble pai, IndividuoDouble filho){
        ...
        filho.getCromossomos().addAll(filho.getCromossomos());
        
        for(int i = cInicial;i<cFinal;i++){
            filho.getCromossomos().set(i, pai.getCromossomos().get(i));
        }
